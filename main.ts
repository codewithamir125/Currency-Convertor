...
console.log(chalk.bold.rgb(204, 204, 204)(`<<<==========>>>  ${chalk.bold.hex('#9999FF')('Welcome To \'Code With Amir\' - Currency Converter')}  <<<===========>>>`));



// Define the list of currencies and theire exchange rate
